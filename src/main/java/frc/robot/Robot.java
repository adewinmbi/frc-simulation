...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    ...
    SmartDashboard.putNumber("Left Follower Position", m_leftDrive.getSelectedSensorPosition());
  }
  ...
  public void simulationPeriodic() {
    ...
    SmartDashboard.putNumber("Left Drive Output Voltage", m_leftDriveSim.getMotorOutputLeadVoltage());
